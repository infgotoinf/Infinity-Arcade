...
select:
    for (int i = 0; i < 2; i++) { // Цикл фор чтобы бага при запуске экзешника не было
        ...
        SetConsoleCursorPosition(console, { 36, 6 }); std::cout << "\033[41m      \033[40m" << "  " << "\033[42m    \033[40m" << "  " <<                 "\033[100m    " <<   "\033[41m      \033[100m  \033[40m  \033[100m  \033[40m" << "  " << "\033[42m    " << "\033[100m  \033[40m  \033[100m  " << "\033[41m      " <<   "\033[100m  \033[40m";
        std::cout << "\tV1.1.5";
